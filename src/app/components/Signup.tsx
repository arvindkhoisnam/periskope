    ...
    <div className="flex flex-col max-w-96 gap-5 p-10 border rounded-xl shadow-2xl bg-neutral-100">
      ...
      {isError && (
        <p className="text-red-700 text-sm tracking-wide font-extralight text-center">
          An error while signing up, please try again.
        </p>
      )}
      <p className="text-neutral-700 text-sm tracking-wide font-extralight">
        Already have an account?{" "}
        <a className="underline text-green-700 cursor-pointer" href="/signin">
          SignIn
        </a>{" "}
        here.
      </p>
